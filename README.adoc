...
No more features, just bugfixes and patches.*
====
...
Only bug fixes will be provided going forward. *We strongly recommend migrating to the official agrirouter© REST-API*, which is the supported and recommended way to integrate with the agrirouter© platform.
...
If you are starting a new integration or looking for a long-term supported solution, please consider using the official agrirouter© REST-API provided directly by the agrirouter© team.
