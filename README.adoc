...
No need for special documentation, no breaking or important changes. Just bugfixing.
...
With https://github.com/agrirouter-middleware/agrirouter-middleware/pull/167[PR 167] the naming was updated. The name `applicationId` has was misleading and therefore it has been changed.
