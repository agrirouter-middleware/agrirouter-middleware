...
image::https://github.com/user-attachments/assets/946ce102-9224-45e7-9279-72a462e1755b[Maintenance Mode - No New Features, No Further Development, Bug Fixes Only]

The agrirouter© middleware will no longer receive new features or active development.
Only bug fixes will be provided going forward.
*We strongly recommend migrating to the https://docs.my-agrirouter.com[official agrirouter© REST-API]*, which is the supported and recommended way to integrate with the agrirouter© platform.
====

== Thank You

We want to take a moment to sincerely thank everyone who has used the agrirouter© middleware over the years.
Your feedback, contributions, and trust in this project have been invaluable.
The agrirouter© middleware was built to lower the barrier of entry for agrirouter© integrations, and we hope it served that purpose well for you and your teams.

Thank you to all our partners, contributors, and users — your support made this project what it is.

If you are starting a new integration or looking for a long-term supported solution, please consider using the https://docs.my-agrirouter.com[official agrirouter© REST-API] provided directly by the agrirouter© team.
